-- pacientes que cumplen compisite prod y pcad indicador 24 
create or replace view composite_5 as with denominador as (
        select a.*,
            discharge_dt,
            end_intervention_dt,
            anesth_cd,
